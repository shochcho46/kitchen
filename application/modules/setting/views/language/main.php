            ...
            <div class="panel-body">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <td colspan="3">
                                <?= form_open('setting/language/addlanguage', ' class="form-inline" ') ?> 
                    ...
                    <tbody>
                        <?php if (!empty($languages)) {?>
                            ...
                            <tr>
                                <td><?= $sl++ ?></td>
                                <td><?= $language ?></td>
                                <td><a href="<?= base_url("setting/language/editPhrase/$key") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>  
                                </td> 
                            </tr>
                            <?php } ?>
                        <?php } ?>
