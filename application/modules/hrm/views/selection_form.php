...
<a href="<?php echo base_url();?>hrm/Candidate_select/candidate_selection_view" class="btn btn-primary"><?php echo display('manage_selection') ?></a>
<?php endif; ?>
</div>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('hrm/Candidate_select/create_selection') ?>
