                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                   ...
                                   <td>
                                    ...
                                    <?php if($this->permission->method('hrm','update')->access()): ?>
                                        <a href="<?php echo base_url("hrm/Candidate/update_canifo_form/$que->can_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> 
                                         <?php endif; ?>
                                    
                                    <?php if($this->permission->method('hrm','delete')->access()): ?> 
                                        <a href="<?php echo base_url("hrm/Candidate/delete_canInfo/$que->can_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a>
                                        <?php endif; ?> 
                                        <?php if($this->permission->method('hrm','read')->access()): ?> 
                                        <a href="<?php echo base_url("hrm/Candidate/cv/$que->can_id");?>" class="btn btn-default btn-xs"> <i class="fa fa-eye"></i></a>
                                        <?php endif; ?> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
