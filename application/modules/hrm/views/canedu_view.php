                        ...
                        <?php if (!empty($edu)) { ?>
                            ...
                            <?php foreach ($edu as $que) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url("hrm/Candidate/update_can_eduifo_form/$que->can_edu_id") ?>" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> 
                                        <a href="<?php echo base_url("hrm/Candidate/delete_can_edu_Info/$que->can_edu_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
