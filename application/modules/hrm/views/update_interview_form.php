...
<a href="<?php echo base_url();?>hrm/Candidate_select/candidate_interview_view" class="btn btn-primary"><?php echo display('manage_interview') ?></a>
<?php endif; ?>
</div>
  ...
  <?= form_open_multipart('hrm/Candidate_select/interview_update_form/'. $data->can_int_id) ?>
...
function SelectToLoad(id){
    ...
    $.ajax({
        url : "<?php echo site_url('hrm/Candidate_select/select_interviewlist/')?>" + id,
        type: "GET",
        dataType: "JSON",
