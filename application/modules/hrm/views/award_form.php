...
<a href="<?php echo base_url();?>hrm/Award_controller/award_view" class="btn btn-primary"><?php echo display('manage_award') ?></a>
<?php endif; ?>
</div>
<!--  -->
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open_multipart('hrm/Award_controller/create_award') ?>
