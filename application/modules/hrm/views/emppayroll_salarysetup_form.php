...
<a href="<?php echo base_url();?>hrm/Payroll/emp_salary_setup_view" class="btn btn-primary"><?php echo display('manage_salary_type')?></a>
  <?php endif; ?>
</div>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('hrm/Payroll/create_salary_setup') ?>
