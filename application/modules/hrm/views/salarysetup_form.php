 ...
 <a href="<?php echo base_url();?>hrm/Payroll/salary_setup_view" class="btn btn-primary"><?php echo display('manage_salary_setup') ?></a>
<?php endif; ?>
</div>
          ...
          <div class="col-sm-12 col-md-12">
            <div class="panel">
              ...
              <div class="panel-body">
                ...
                <?= form_open('hrm/Payroll/create_s_setup') ?>
 ...
 function handletax(checkbox){
  ...
  var netamount = amount+tax;
    if(checkbox.checked == true){
       $.ajax({
        url : '<?php echo site_url('hrm/Payroll/salarywithtax/')?>',
            method: 'post',
            dataType: 'json',
            data: 
            {
...
//alert(id);
$.ajax({
  url:"<?php echo base_url('hrm/Payroll/employeebasic/')?>",
  method:'post',
  dataType:'json',
  data:{
'employee_id': id,
