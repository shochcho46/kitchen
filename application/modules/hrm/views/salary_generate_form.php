...
<a href="<?php echo base_url();?>hrm/Payroll/salary_generate_view" class="btn btn-primary"><?php echo display('manage_salary_generate')?></a>
<?php endif; ?>
</div>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('hrm/Payroll/create_salary_generate') ?>
