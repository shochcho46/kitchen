    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                         <?= form_open_multipart('hrm/Cexpense/create_expense') ?>
                                <div class="row">
                          <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker5" value="<?php  echo date('Y-m-d');?>">
                            ...
                            <div class="col-sm-12" id="payment_from_1">
                                <div class="form-group row">
                                    <label for="payment_type" class="col-sm-4 col-form-label"><?php
                                        ...
                                        ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                                        <select name="paytype" class="form-control" id="paytype" onchange="bank_paymet(this.value)" required="">
                                ...
                                <div class="form-group row">
                                    <label for="payment_type" class="col-sm-4 col-form-label"><?php
                                        ...
                                        ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                                    <select name="bank_id" class="form-control" id="bank" style="width:100%">
                                    <option value="">Select Payment Option</option>
                                            <?php foreach($bank_list as $banks){?>
                                            <option value="<?php echo $banks['bankid']?>"><?php echo $banks['bank_name']?></option>
                                            <?php }?>
