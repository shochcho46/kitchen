...
<a href="<?php echo base_url();?>hrm/Department_controller/dept_view" class="btn btn-primary"><?php echo display('manage_dept')?></a>
<?php endif; ?>
</div>
<!--  -->
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('hrm/Department_controller/create_dept'); ?>
