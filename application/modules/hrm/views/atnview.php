...
<a href="<?php echo base_url();?>/hrm/Home/manageatn" class="btn btn-primary"><?php echo display('manage_attendance')?></a>
 <?php endif; ?> 
</div>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel ">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('hrm/Home/create_atten') ?>
