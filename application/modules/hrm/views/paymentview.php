                            ...
                            <?php foreach ($emp_pay as $que) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <?php if($this->permission->method('hrm','delete')->access()): ?> 
                                        <a href="<?php echo base_url("hrm/Employees/delete_payment/$que->emp_sal_pay_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a>
                                        <?php endif; ?> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
   ...
   <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-bd">
                ...
                <?= form_open('hrm/Employees/payconfirm/'. $data->emp_sal_pay_id) ?>
...
function Payment(salpayid,employee_id,TotalSalary,WorkHour,Period){
   ...
   var employee_id = employee_id;
    $.ajax({
    url:"<?php echo base_url('hrm/Employees/EmployeePayment/')?>",
    method:'post',
    dataType:'json',
    data:{
     'sal_id':sal_id,
