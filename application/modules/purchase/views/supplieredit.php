                ...
                <div class="panel-body">
                    ...
                    <input name="supcode" type="hidden" value="<?php echo $intinfo->suplier_code;?>" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input name="email" class="form-control" type="text" placeholder="Add <?php echo display('email') ?>" id="email" value="<?php echo (!empty($intinfo->supEmail)?$intinfo->supEmail:null) ?>">
                            </div>
                        </div>
                        <div class="form-group row">
