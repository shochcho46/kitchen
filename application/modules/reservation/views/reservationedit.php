                ...
                <div class="panel-body">
                    ...
                    <div class="form-group row">
                       ...
                       <div class="form-group row">
                    	...
                    	<div class="form-group row">
                        <label for="customer_name" class="col-sm-4 col-form-label"><?php echo "Customer Notes"; ?>*</label>
                        <div class="col-sm-8">
                        <input name="email" class="form-control" type="text" id="email" value="<?php echo (!empty($intinfo->customer_notes)?$intinfo->customer_notes:null) ?>" placeholder="Customer Notes">
                        </div>
                    </div>
						<div class="form-group row">
