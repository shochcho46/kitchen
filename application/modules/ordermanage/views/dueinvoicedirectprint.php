      ...
      <tr>
        <td>
          ...
          <table width="100%">
            ...
            <?php if($orderinfo->order_status==1 || $orderinfo->order_status==2){?>
				 <tr>
              <td align="left"></td>
              <td align="left" colspan="3"><?php echo display('total_due')?></td>
              <td align="right"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo $calvat+$itemtotal+$servicecharge-$discount;?> <?php if($currency->position==2){echo $currency->curr_icon;}?></td>
            </tr>
				<?php }else{
		...
		<table width="100%">
        	<tr>
                ...
                <td><?php echo display('user')?>: <?php echo $this->session->userdata('fullname');?></td>
            </tr>
        </table>
        </td>
      </tr>
