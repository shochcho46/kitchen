                   ...
                   <div class="panel">
                     ...
                     <div class="owl-carousel owl-theme">
                      <?php for($k=0;$k<=$length-1;$k++){
						 ...
						 ?>
                      <div> <table class="table table-bordered table-hover bg-white" style="width:100%;">
                                    <thead>
									...
									if(!empty($counterorder)){
                                       ...
                                       <tr>
                                          ...
                                          <td style="font-weight:bold;"><?php if($st==1){?><div class="countdown_<?php echo $i;?>"><?php //echo $mins;?></div><?php }else{ echo "Time Over";}?></td>
...
function oredrisready(orderid){
 ...
 setInterval(function(){ 
  window.location.href = "<?php echo base_url();?>ordermanage/order/counterboard";
 }, <?php echo $reloadtime;?>);
});
</script>
