	 ...
	 ?>
                                  		<div class="col-sm-2">
                                            <div class="hero-widget well well-sm" style="height:auto !important">
                                                    <p style="margin:0;"><label class="text-muted"><strong><?php echo display('table');?>:<?php echo $onprocess->tablename;?></strong></label><small class="pull-right"><a href="<?php echo base_url("ordermanage/order/updateorder/".$onprocess->order_id) ?>" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="" data-original-title="Update Order"><i class="fa fa-pencil"></i></a></small></p>
                                                    <p style="margin:0;"><label class="text-muted"><?php echo display('ord_num');?>:<?php echo $onprocess->saleinvoice;?></label></p>
