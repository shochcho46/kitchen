        ...
        <div class="panel panel-bd ">
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    <a href="<?php echo base_url()?>dashboard/web_setting/bannersetting" class="btn btn-success"><i class="fa fa-plus"></i> <?=display('banner_list')?></a>
                    </div>
            ...
            <div class="panel-body">
 					<?= form_open('dashboard/web_setting/createtype',array('id'=>'typeurl')) ?>
...
function edittype(typename,typeid){
	...
	$('#typeurl').attr('action', "<?php echo base_url()?>dashboard/web_setting/edittype/"+typeid);
	}
</script>
