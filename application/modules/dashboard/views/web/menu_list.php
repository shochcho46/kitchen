    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd ">
            ...
            <div class="panel-body">
 					<?= form_open('dashboard/web_setting/createmenu',array('id'=>'menuurl')) ?>
                        ...
                        <div class="form-group text-right" style="display:none;" id="upbtn">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                	...
                                	<!--<a href="<?php //echo base_url("dashboard/web_setting/deletemenu/$value->menuid") ?>" onclick="return confirm('<?php //echo display("are_you_sure") ?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></a>-->
                                </td>
                            </tr>
							<?php if(!empty($value->sub)){
                                ...
                                <td>
                                 ...
                                 <!--<a href="<?php //echo base_url("dashboard/web_setting/deletemenu/$submenu->menuid") ?>" onclick="return confirm('<?php //echo display("are_you_sure") ?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></a>-->
                                </td>
                            </tr>
								<?php }}?>
...
function editmenu(menuname,menuurl,status,parent,menuid){
	...
	$("#upbtn").show();
	$('#menuurl').attr('action', "<?php echo base_url()?>dashboard/web_setting/editmenu/"+menuid);
	}
</script>
