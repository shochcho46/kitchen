        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
				...
				echo form_open_multipart('dashboard/web_setting/email_config_save','class="form-inner"') ?>
                    ...
                    <div class="col-xs-9">
                         <input type="text" name="smtp_host" value="<?php echo @$config->smtp_host;?>" required="1" class="form-control" readonly="readonly">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                         <input type="text" name="smtp_port" value="<?php echo @$config->smtp_port;?>" required="1" class="form-control" readonly="readonly">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                         <input type="text" name="api_key" value="<?php echo @$config->api_key;?>" required="1" class="form-control" readonly="readonly">
                    </div>
                </div>
