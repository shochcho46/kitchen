        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open_multipart('dashboard/web_setting/create') ?>
        ...
        <div class="panel panel-bd ">
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    <!--<a href="<?php //echo base_url()?>dashboard/web_setting/bannertype" class="btn btn-success" style="margin-right:10px;"><i class="fa fa-plus"></i> <?php //echo display('bannertype')?></a>-->
                    <a data-target="#add0" data-toggle="modal" class="btn btn-success"><i class="fa fa-plus"></i> <?=display('add_banner')?></a>
                    </div>
...
function editbanner(id){
	   var myurl ='<?php echo base_url()?>dashboard/web_setting/updateintfrm/'+id;
