...
class App extends MY_Controller {
	...
	public function ordersync(){
		...
		if($orderlist->payment_method_id==1 && $orderlist->bill_status==1){
		$cardinfo=array(
			'bill_id'			    =>	$billid,
			'card_no'		        =>	$orderlist->card_no,
			'terminal_name'	        =>	$orderlist->terminal_name,
			'bank_name'	            =>	$orderlist->bank_name
		);
