                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control productSelection"  onkeypress="producstList();" name="product_name" id="product_name" placeholder="Search Restaurent food item" aria-required="true"> <input class="autocomplete_hidden_value" name="product_id" id="SchoolHiddenId" type="hidden">
                            </div>
                        </div>
                        <div class="col-md-4 mb-3 mb-md-0">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control categorySelection" onkeypress="allcategoryList();" name="category_name" id="category_name" placeholder="Category"><input class="autocomplete_hidden_value2" name="category_id" id="SchoolHiddenId2" type="hidden">
                            </div>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="item">
                        ...
                        <?php } ?>
                            ...
                            <div id="snackbar<?php echo $id;?>" class="snackbar">Item has been successfully added</div>
                             <a onclick="addonsitem(<?php echo $best->ProductsID;?>,<?php echo $best->variantid;?>,'other')" class="simple_btn"data-toggle="modal" data-target="#addons" data-dismiss="modal"> <i class="ti-shopping-cart mr-2"></i><span>add to cart</span></a>
                             <?php } else{?>
                        ...
                        <input type="hidden" name="cartpage" id="cartpage_<?php echo $id;?>other" value="0">
                         <input name="itemprice" type="hidden" value="<?php echo $best->price;?>" id="itemprice_<?php echo $id;?>other" />
                             <div id="snackbar<?php echo $id;?>" class="snackbar">Item has been successfully added</div>
                             <a onclick="addtocartitem(<?php echo $best->ProductsID;?>,<?php echo $id;?>,'other')" class="simple_btn"> <i class="ti-shopping-cart mr-2"></i><span>add to cart</span></a>
                              <?php } 
							}
							else{
							echo $availavail;
            ...
            <div class="row about_inner">
                ...
                <div class="col-xl-6 col-lg-5 text-center pl-lg-5 px-3 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="aboutus_text">
                        ...
                        <a href="<?php echo $banner_menu[0]->slink;?>" class="simple_btn">View Full Menu</a>
                    </div>
                    <?php } ?>
                </div>
            </div>
                    ...
                    <div class="menu_slider owl-carousel">
                        ...
                        <div class="menu_item">
                            <div class="menu_info">
                                ...
                                <h2><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><?php echo $special->price;?><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></h2>
