        ...
        <div class="container">
            <div class="row">
                ...
                <div id="form-container">
                    ...
                    <form role="form" action="<?php echo base_url()?>hungry/stripePostqr" method="post" class="require-validation" data-stripe-publishable-key="<?php echo $paymentinfo->password;?>" id="payment-form">
