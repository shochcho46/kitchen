        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12" id="mycartlist">
                    <h6 class="cart_heading">Update Summery List</h6>
                    <?php $totalqty=0;
...
<input class="btn btn-success btn-block" style="border:none;" name="" type="submit" value="Update order" />
</div>
</div>
</div>
</div>
